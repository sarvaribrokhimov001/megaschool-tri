  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gray-900 shadow-md z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <button className="hidden md:block bg-secondary text-gray-900 font-bold px-5 py-2 rounded-lg hover:bg-gray-900 hover:text-secondary hover:border-3 hover:border-secondary duration-300"> Register </button>
