export default function About() {
  ...
  return (
    <section id="about" className="bg-gray-900 border-3 border-secondary">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <span className="text-secondary text-2xl font-bold"> ABOUT US </span>
          <h2 className="text-4xl font-bold mt-3"> Welcome to MegaSchool </h2>
          <p className="text-secondary font-bold mt-6 leading-8"> MegaSchool is one of the leading learning centers providing English, Programming, Mathematics and IT courses.
